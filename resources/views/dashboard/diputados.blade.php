...
@section('title', 'Dashboard Diputados - Resumen en tiempo real')
...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <ul class="nav nav-pills">
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('dashboard.presidente') }}">
                        <i class="fas fa-vote-yea"></i> Dashboard Presidencial
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="{{ route('dashboard.diputados') }}">
                        <i class="fas fa-users"></i> Dashboard Diputados
                    </a>
                </li>
            </ul>
        </div>
    ...
    <h1 class="mb-4">
        <i class="fas fa-users"></i> Dashboard Diputados - Resumen en tiempo real
    </h1>
    ...
    @if($election)
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">
                            ...
                            Progreso de Actas Registradas - {{ $election->name }}
                        </h5>
                        <div class="progress mb-3" style="height: 25px;">
                            @php
                                $porcentaje = ($mesasCompletadas / 16) * 100;
                            @endphp
                            <div class="progress-bar {{ $todasCompletadas ? 'bg-success' : 'bg-warning' }}" 
                                 role="progressbar" 
                        ...
                        <p class="card-text">
                            <strong>{{ $mesasCompletadas }}</strong> de <strong>16</strong> mesas han registrado sus actas de diputados.
                        </p>
                        @if($todasCompletadas)
                            <div class="alert alert-success mb-0">
                                <i class="fas fa-check-circle me-2"></i>
                                <strong>¡Conteo de diputados completo!</strong> Todas las 16 mesas han registrado sus actas. El proceso electoral de diputados ha finalizado.
                            </div>
                        @endif
                    </div>
                </div>
        ...
        <div class="row mb-4">
            <div class="col-12">
                <h4 class="mb-3">
                    ...
                    Resultados por Candidato a Diputado
                </h4>
            </div>
        </div>
        <div class="row mb-4">
                    ...
                    <div class="candidate-card" style="background: linear-gradient(135deg, {{ $candidate['color_hex'] }} 0%, {{ $candidate['color_hex'] }}dd 100%); color: white;">
                        ...
                        @if($candidate['sigla'])
                            <div class="text-center mt-2">
                                <small style="opacity: 0.9;">{{ $candidate['sigla'] }}</small>
                            </div>
                        @endif
                    </div>
                </div>
        ...
        <div class="text-muted mb-4">
            Última actualización: {{ $lastUpdate->format('d/m/Y h:iA') }}
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="chart-container">
                    <h5 class="mb-3">Tendencia de Votos para Diputados</h5>
            ...
            <div class="col-md-4">
                <div class="chart-container">
                    <h5 class="mb-3">Distribución de Votos para Diputados</h5>
    ...
    @else
        <div class="alert alert-info text-center">
            ...
            No hay elección de diputados activa. 
