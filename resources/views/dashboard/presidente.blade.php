...
@section('title', 'Dashboard Presidencial - Resumen en tiempo real')
...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <ul class="nav nav-pills">
                <li class="nav-item">
                    <a class="nav-link active" href="{{ route('dashboard.presidente') }}">
                        <i class="fas fa-vote-yea"></i> Dashboard Presidencial
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('dashboard.diputados') }}">
    ...
    <h1 class="mb-4">
        <i class="fas fa-vote-yea"></i> Dashboard Presidencial - Resumen en tiempo real
    </h1>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            <strong>{{ $mesasCompletadas }}</strong> de <strong>16</strong> mesas han registrado sus actas presidenciales.
                        </p>
                        @if($todasCompletadas)
                            <div class="alert alert-success mb-0">
                                <i class="fas fa-check-circle me-2"></i>
                                <strong>¡Conteo presidencial completo!</strong> Todas las 16 mesas han registrado sus actas. El proceso electoral presidencial ha finalizado.
                            </div>
                        @endif
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="chart-container">
                    <h5 class="mb-3">Tendencia de Votos Presidenciales</h5>
            ...
            <div class="col-md-4">
                <div class="chart-container">
                    <h5 class="mb-3">Distribución de Votos Presidenciales</h5>
    ...
    @else
        <div class="alert alert-info text-center">
            ...
            No hay elección presidencial activa. 
