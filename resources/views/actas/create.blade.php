            ...
            setTimeout(() => {
                if (window.mostrarGanadorProvisional) {
                    ...
                    if (winner && maxVotes > 0) {
                        window.mostrarGanadorProvisional('presidente', winner, maxVotes, 'Cómputo parcial - datos insuficientes para un ganador definitivo');
                    } else {
                        window.mostrarDatosInsuficientes('presidente');
                    }
                }
            }, 2000);
        });
